...
func Create(peer *Peer) (*BootstrapDataAPI, error) {
	...
	//fmt.Printf("BOOTSTRAP_DATA_SERVER: %q\n", serviceUrl)
...
func (api *BootstrapDataAPI) List() *BootstrapData {
	...
	//fmt.Printf("Received reply from %q List: %v\n", api.ServiceUrl, res.Status)
...
func (api *BootstrapDataAPI) UpdateConfig() (*BootstrapData, error) {
	...
	//fmt.Printf("Received reply from UpdateConfig %d %d: %v\n",
	//	api.BootstrapData.Config.MaxPeers, api.BootstrapData.Config.MinRefillCandidates, res.Status)
